...
@dataclass
class Qwen2_5_VL_VLAOutput(Base_VLAOutput, Qwen2_5_VLCausalLMOutputWithPast):
    """
    Output for Qwen2-5 VL VLA model.
    """


class Qwen2_5_VL_VLAConfig(Base_VLAConfig, Qwen2_5_VLConfig):
    """
    Config for Qwen2-5 VL VLA model.
    """

@register_custom_model
class Qwen2_5_VL_VLA(Qwen2_5_VLForConditionalGeneration):
    config_class = Qwen2_5_VL_VLAConfig

    def __init__(self, config: Qwen2_5_VL_VLAConfig):
    ...
    ) -> Union[Tuple, Qwen2_5_VL_VLAOutput]:
        r"""
        Override forward to compute diffusion loss.
        """
